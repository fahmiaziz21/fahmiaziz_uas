                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <div class="dropzone required" input="#ctrl-name" fieldname="name"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1">
                                                    <input name="name" id="ctrl-name" required="" class="dropzone-input form-control" value="<?php  echo $data['name']; ?>" type="text"  />
                                                        <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                        <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                    </div>
                                                    <div class="check-status"></div> 
                                                </div>
                                                <?php Html :: uploaded_files_list($data['name'], '#ctrl-name'); ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
